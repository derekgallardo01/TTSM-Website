        ...
        <div id="header">
            ...
            <div class="total-width">
                ...
                <?php if( $header_image ): $custom_header = get_custom_header(); ?>
                    ...
                    <div id="logo">
                        ...
                        <a href="<?php echo site_url(); ?>">
                            ...
                            <img src="https://ahhthatsthespotmassage.com/wp-content/uploads/2022/01/Modified-Logo-4.png" height="<?php echo $custom_header->height; ?>" width="<?php echo $custom_header->width; ?>" 
                ...
                <div class="right-header-2">
                    ...
                    <div id="menu-header"><?php wp_nav_menu( array( 'theme_location' => 'header-menu-2','menu_class' => 'menu','container_class' => 'sm-menu','menu_id' => 'nav-header-menu' ) ); ?></div>
            ...
            <div id="wrapper-main-menu" style="display:none;">

                <div id="main-menu" class="total-width">

                    <?php wp_nav_menu( array( 'theme_location' => 'primary','container_class' => 'sm-menu','menu_id' => 'nav-menu' ) ); ?>
