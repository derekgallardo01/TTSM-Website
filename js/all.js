...
function form_validation_van_user(){
        if(jQuery("input[name=input_33]").length && jQuery("input[name=input_33]").val()==''){
            alert('Please fill first name');
            jQuery("input[name=input_33]").focus();
            return false;
        }

        if(jQuery("select[name=input_7]").length && (jQuery("select[name=input_7] option:selected").length == 0 || jQuery("select[name=input_7] option:selected").val()=='')){
            alert('Please select number of therapist');
            jQuery("select[name=input_7]").focus();
            return false;
        }

        if(jQuery("input[name=input_53]").length && jQuery("input[name=input_53]").val()==''){
            alert('Please select date');
            jQuery("input[name=input_53]").focus();
            return false;
        }

        if(jQuery("input[name=input_64]").length && jQuery("input[name=input_64]").val()==''){
            alert('Please select start time');
            jQuery("input[name=input_64]").focus();
            return false;
        }

        if(jQuery("input[name=input_65]").length && jQuery("input[name=input_65]").val()==''){
            alert('Please select end time');
            jQuery("input[name=input_65]").focus();
            return false;
        }


        if(jQuery("select[name=input_28]").length && (jQuery("select[name=input_28] option:selected").length == 0 || jQuery("select[name=input_28] option:selected").val()=='') ){
            alert('Please select time zone');
            jQuery("select[name=input_28]").focus();
            return false;
        }

        if(jQuery("input[name=input_8]").length && jQuery("input[name=input_8]").val()==''){
            alert('Please put the event address');
            jQuery("input[name=input_8]").focus();
            return false;
        }

        if(jQuery("input[name=input_9]").length && jQuery("input[name=input_9]").val()==''){
            alert('Please fill city');
            jQuery("input[name=input_9]").focus();
            return false;
        }
        
        if(jQuery("select[name=input_10]").length && (jQuery("select[name=input_10] option:selected").length == 0 || jQuery("select[name=input_10] option:selected").val()=='' ) ){
            alert('Please select state');
            jQuery("select[name=input_10]").focus();
            return false;
        }

        if(jQuery("input[name=input_51]").length && jQuery("input[name=input_51]").val()==''){
            alert('Please fill zip code');
            jQuery("input[name=input_51]").focus();
            return false;
        }

        for(var i = 1; i<20; i++){
            if(jQuery("input[name=input_33_"+i+"_1]").length && jQuery("input[name=input_33_"+i+"_1]").val()==''){
                alert('Please fill first name');
                jQuery("input[name=input_33_"+i+"_1]").focus();
                return false;
            }
    
            if(jQuery("select[name=input_7_"+i+"_5]").length && (jQuery("select[name=input_7_"+i+"_5] option:selected").length == 0 || jQuery("select[name=input_7_"+i+"_5] option:selected").val()=='')){
                alert('Please select number of therapist');
                jQuery("select[name=input_7_"+i+"_5]").focus();
                return false;
            }
    
            if(jQuery("input[name=input_53_"+i+"_6]").length && jQuery("input[name=input_53_"+i+"_6]").val()==''){
                alert('Please select date');
                jQuery("input[name=input_53_"+i+"_6]").focus();
                return false;
            }
    
            if(jQuery("input[name=input_64_"+i+"_7]").length && jQuery("input[name=input_64_"+i+"_7]").val()==''){
                alert('Please select start time');
                jQuery("input[name=input_64_"+i+"_7]").focus();
                return false;
            }
    
            if(jQuery("input[name=input_65_"+i+"_8]").length && jQuery("input[name=input_65_"+i+"_8]").val()==''){
                alert('Please select end time');
                jQuery("input[name=input_65_"+i+"_8]").focus();
                return false;
            }
    
    
            if(jQuery("select[name=input_28_"+i+"_9]").length && (jQuery("select[name=input_28_"+i+"_9] option:selected").length == 0 || jQuery("select[name=input_28_"+i+"_9] option:selected").val()=='') ){
                alert('Please select time zone');
                jQuery("select[name=input_28_"+i+"_9]").focus();
                return false;
            }
    
            if(jQuery("input[name=input_8_"+i+"_11]").length && jQuery("input[name=input_8_"+i+"_11]").val()==''){
                alert('Please put the event address');
                jQuery("input[name=input_8_"+i+"_11]").focus();
                return false;
            }
    
            if(jQuery("input[name=input_9_"+i+"_12]").length && jQuery("input[name=input_9_"+i+"_12]").val()==''){
                alert('Please fill city');
                jQuery("input[name=input_9_"+i+"_12]").focus();
                return false;
            }
            
            if(jQuery("select[name=input_10_"+i+"_13]").length && (jQuery("select[name=input_10_"+i+"_13] option:selected").length == 0 || jQuery("select[name=input_10_"+i+"_13] option:selected").val()=='' ) ){
                alert('Please select state');
                jQuery("select[name=input_10_"+i+"_13]").focus();
                return false;
            }
    
            if(jQuery("input[name=input_51_"+i+"_14]").length && jQuery("input[name=input_51_"+i+"_14]").val()==''){
                alert('Please fill zip code');
                jQuery("input[name=input_51_"+i+"_14]").focus();
                return false;
            }
 
         }

        if(jQuery("input[name=input_29]").length && jQuery("input[name=input_29]:checked").val()!='yes'){
            alert('Please accept policy');
            jQuery("input[name=input_29]").focus();
            return false;
        }
...
jQuery(function(e){
    ...
    jQuery("#gform_11").submit(function(){
        ...
        return form_validation_van_user();
